...
import stylesKarmaCounter from './karmaCounter.css';
import stylesCommentsButton from './commentButton.css';
import stylesShareButton from './shareButton.css';
import stylesSaveButton from './saveButton.css';
import stylesControls from './controls.css';
  ...
  return (
    <div className={stylesControls.controls}>
      <div className={stylesKarmaCounter.karmaCounter}>
          <button className={stylesKarmaCounter.up}>
        ...
        <button className={stylesCommentsButton.commentsButton}>
        ...
        <div className="actions">
          <button className={stylesShareButton.shareButton}>
          ...
          <button className={stylesSaveButton.saveButton}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="10" cy="10" r="10" fill="#C4C4C4"/>
